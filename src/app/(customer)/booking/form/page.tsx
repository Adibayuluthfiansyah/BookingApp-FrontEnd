...
export default function BookingFormPage() {
  ...
  }, [user, loadBookingData]);

  // Cleanup timer on error
  useEffect(() => {
    if (error && !bookingData) {
      const timer = setTimeout(() => router.push("/venues"), 2000);
      return () => clearTimeout(timer);
    }
  }, [error, bookingData, router]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        const errorMessage =
          result.message || "Gagal membuat booking. Silakan coba lagi.";
  ...
  const adminFee = 5000;
  const totalAmount = (bookingData.price || 0) + adminFee;
  ...
  return (
    <>
      <Script
        ...
        onError={(_e) => {
          console.error("=== MIDTRANS SCRIPT ERROR ===", _e);
          setError(
            "Gagal memuat script pembayaran Midtrans. Periksa koneksi internet atau coba refresh."
          );
        }}
      />
          ...
          <div className="max-w-4xl mx-auto px-4 py-4 flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                Lengkapi data untuk melanjutkan booking
              </p>
            </div>
          </div>
        </div>
              ...
              >
                ...
                <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-blue-700">
                    ...
                    mengklik tombol di bawah. Pilih metode pembayaran yang Anda
                    inginkan (Transfer Bank, E-Wallet, Kartu Kredit, dll).
                  </p>
                </div>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
                ...
                <div className="mt-4 p-3 bg-orange-50 rounded-lg">
                  <div className="text-xs text-orange-800">
                    <strong>Catatan:</strong> Booking akan dikonfirmasi setelah
                    pembayaran berhasil. Silakan simpan nomor booking untuk
                    referensi.
                  </div>
                </div>
              </div>
